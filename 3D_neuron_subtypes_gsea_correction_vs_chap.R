...
#for  EN_deep_w10
EN_deep_w10 = read_tsv("ranks_EN_deep.correction_vs_chap_cellranger_w10_sct_cca_wilcox_lfc.rnk")
...
#for  EN_deep_w21
EN_deep_w21 = read_tsv("ranks_EN_deep.correction_vs_chap_cellranger_w21_sct_cca_wilcox_lfc.rnk")
...
#for  EN_upper_w10
EN_upper_w10 = read_tsv("ranks_EN_upper.correction_vs_chap_cellranger_w10_sct_cca_wilcox_lfc.rnk")
...
#for  EN_upper_w21
EN_upper_w21 = read_tsv("ranks_EN_upper.correction_vs_chap_cellranger_w21_sct_cca_wilcox_lfc.rnk")
...
#for  IN_w10
IN_w10 = read_tsv("ranks_IN.correction_vs_chap_cellranger_w10_sct_cca_wilcox_lfc.rnk")
IN_w10.gsea <- IN_w10$rank
names(IN_w10.gsea) <- as.character(IN_w10$GeneName)
IN_w10.gsea <- sort(IN_w10.gsea, decreasing = T)
#for  IN_w21
IN_w21 = read_tsv("ranks_IN.correction_vs_chap_cellranger_w21_sct_cca_wilcox_lfc.rnk")
...
test.out<- compareCluster(geneCluster=inputList, fun="GSEA", pvalueCutoff=0.05,
                          ...
                          seed = T)
saveRDS(test.out, "w10_w21_EN_d_u_IN_neuron_cluster_correction_vs_chap_comparecluster_10_500_8.11.22.rds")
