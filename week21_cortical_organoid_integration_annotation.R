...
new_ident_1 <- setNames(c("U1", #0 
                          ...
                          "U2", #4 DLK1
                          "EN_upper",  #5 
                          "tRG", #6 tRG: CRYAB, HOPX
                          "EN_upper", #7
                          "Astrocyte", #8,***
                          "IN", #9  ***
                          "Cajal-Retzius", #10 , ***
                          "IPC", #11, CTNNB1, CLU, QKI, HOPX, PAX6, TNC, PTPRZ1,
                          "EN_upper", #12 ****
                          "Glyc", #13 HMGB2, TOP2A, HELLS, VIM, IPC-div2: CCNB2, KIF15, tRG: HJURP, 
                          "U3",#14 CBLN1, RELN.
                          "Glyc",  #15 ERBB4, DLX6-AS1
                          "U4", #16  ***
                          "Endothelial", #17 HMGB2, TOP2A, HELLS, VIM, PCNA
                          "S/M_phase", #18 , 
                          "U5", #19 ***confirmed by FN1, COL3A1, LUM, Glyc-RG, LDHA, VIM, 
                          "IN", #20 #GAD1#20 confirmed by NPR3, SORCS1, Layer VI CRYM, MEF2C, NEUROD6, Layer VI Pan-area
                          "U6", #21  ***
                          "IN", #22
                          "EN_deep", #23
                          "S_phase", #24
