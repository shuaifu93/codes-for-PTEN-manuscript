...
test.out<- compareCluster(geneCluster=inputList, fun="GSEA", pvalueCutoff=0.05,
                          ...
                          seed = T)
saveRDS(test.out, "w10_w21_NPC_cluster_apex_vs_induction_comparecluster_10_500_8.11.22.rds")
test.out <- readRDS("w10_w21_NPC_cluster_apex_vs_induction_comparecluster_10_500_8.11.22.rds")
