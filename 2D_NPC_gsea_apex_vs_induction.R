...
test.out<- compareCluster(geneCluster=inputList, fun="GSEA", pvalueCutoff=0.05,
                          ...
                          seed = T)
saveRDS(test.out, "2D_NPC_apex_vs_induction_comparecluster_Tx_10_500.rds")
test.out <- readRDS("2D_NPC_apex_vs_induction_comparecluster_Tx_10_500.rds")
