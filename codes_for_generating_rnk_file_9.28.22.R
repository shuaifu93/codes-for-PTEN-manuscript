...
contrast.matrix <- makeContrasts(
  ...
  "Induction vs Control" = Chap_induction - Chap, #1
  "KO vs Control" = Chap_KO - Chap,  #2
  "Autism vs correction" = Apex - Apex_correction, #3
  "KO vs Correction" = Apex_KO - Apex_correction, #4
  "correction vs chap" = Apex_correction - Chap, #5
  "Autism vs Induction" = Apex - Chap_induction, #6
  "AKO vs CKO" = Apex_KO - Chap_KO, #7
