...
test.out<- compareCluster(geneCluster=inputList, fun="GSEA", pvalueCutoff=0.05,
                          ...
                          seed = T)
saveRDS(test.out, "w10_w21_NPC_cluster_induction_vs_chap_comparecluster_10_500_8.10.22.rds")
test.out <- readRDS("w10_w21_NPC_cluster_induction_vs_chap_comparecluster_10_500_8.10.22.rds")
